...
$string['gradereportmultipleeval'] = 'Avaliacións múltiples';
$string['gradereportweighteval'] = 'Avaliacións ponderadas múltiples';
$string['checkbox'] = 'Revisa o libro de cualificacións';
$string['savebutton'] = 'Gardar cambios';
$string['multevalbutton'] = 'Acceda ao editor de avaliación ponderada';
...
$string['additinerary1'] = 'Engade un itinerario';
$string['additinerary2'] = 'Engade un itinerario';
