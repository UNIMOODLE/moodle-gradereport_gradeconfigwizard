...
$url = new moodle_url('/grade/report/gradeconfigwizard/multipleevaluations.php', ['id' => $courseid]);
$PAGE->set_url($url);
...
$actionbar->set_heading_menu(get_string('gradereportmultipleeval', 'gradereport_gradeconfigwizard'));
...
$data = [
    ...
    'urlsaveexit' => new moodle_url('/grade/report/gradeconfigwizard/processgradebook.php',
        ['id' => $courseid, 'type' => 'multiple']),
    'urlcancelmultipleval' => $CFG->wwwroot . "/grade/report/gradeconfigwizard/index.php?id=" . $courseid,
    'hidecategory' => false,
