...
/**
 * Renderer for the gradebook gradeconfigwizard report
 *
 ...
 * $renderer = $PAGE->get_renderer('gradereport_gradeconfigwizard');
 *
 * @copyright 2010 Sam Hemelryk
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gradereport_gradeconfigwizard_renderer extends plugin_renderer_base {
