...
$string['addelement2'] = 'Afegeix un element'; //aquí originalment estava en plural però he interpretat que era un error i que havia de ser en singular, per analogia amb les altres cadenes del mateix tipus
...
$string['wmultitableitineraries'] = 'ITINERARIS'; //per ventura caldria canviar l'identificador de la cadena per incloure la paraula pathways, que és la correcta en aquest context.
