...
$url = new moodle_url('/grade/report/gradeconfigwizard/multipleevaluations.php', array('id' => $courseid));
$PAGE->set_url($url);
...
// echo $OUTPUT->render_from_template('gradereport_gradeconfigwizard/multipleevaluations_example', $data);
