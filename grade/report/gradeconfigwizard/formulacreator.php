...
if($formulaxml !== ""){
    $grade_items = \gradereport_gradeconfigwizard\formulamanager::preprocess_formula_xml($formulaxml, $all_grade_item);
    $formula = \gradereport_gradeconfigwizard\formulamanager::generate_formula_moodle($grade_items);
...
$url = new moodle_url('/grade/report/gradeconfigwizard/formulacreator.php', array('id' => $courseid, 'gradeitemid' => $gradeitemid));
$PAGE->set_url($url);
