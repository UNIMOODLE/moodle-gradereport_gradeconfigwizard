...
class gradebookmanager {
    ...
    private static function move_gradeitem_after(int $draggedgradeitemid, int $targetidgradeitemid, int $courseid, bool $first = false) {
    ...
    public static function get_disabledcategory($courseid, $usecache = false) {
        ...
        $disabledgradeitem = \grade_item::fetch(['iteminstance' => $disabledgradecategory->id,
        ...
        foreach ($gradeitems as $gradeitemkey => $gradeitem) {
            ...
            switch ($gradeitem->itemtype) {
                case 'course':
                    ...
                    $availablegradeitemtotal['parentcategorydepthloop'] = array_fill(0,
                        $availablegradeitemtotal['categorydepth'] - 1, '');
