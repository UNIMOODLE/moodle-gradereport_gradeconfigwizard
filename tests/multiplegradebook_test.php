...
class  gradeconfigwizard_multiplegradebook_test extends \advanced_testcase {
     ...
     * @covers \gradereport_gradeconfigwizard\multiplegradebook::move_grade_item_to_category
     * @covers \gradereport_gradeconfigwizard\multiplegradebook::set_cutoff_mark_calculation
     * @covers \gradereport_gradeconfigwizard\multiplegradebook::create_item_category
    ...
    public function test_process() {
        ...
        $multiplevaluation = new multiplegradebook($this->course1->id);
