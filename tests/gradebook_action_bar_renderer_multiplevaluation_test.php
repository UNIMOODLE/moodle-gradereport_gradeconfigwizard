...
/**
 * Class gradebook_action_bar_renderer_multiplevaluation_test
 *
 * Test cases for the action bar renderer used in the Grade Config Wizard for multiple valuations.
 */
class gradebook_action_bar_renderer_multiplevaluation_test extends \advanced_testcase {
    ...
    public function test_get_template() {
        ...
        $actionbarformula = new \gradereport_gradeconfigwizard\gradebook_action_bar_renderer_multiplevaluation($context);
     ...
     *
     * @covers \gradereport_gradeconfigwizard\gradebook_action_bar_renderer_multiplevaluation::export_for_template
     */
