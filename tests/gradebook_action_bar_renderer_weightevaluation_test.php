...
require_once('grade/report/gradeconfigwizard/classes/gradebook_action_bar_renderer_weightevaluation.php');

class gradeconfigwizard_gradebook_action_bar_renderer_weightevaluation_test extends \advanced_testcase {
    ...
    public function test_get_template() {
        ...
        $actionbarformula = new \gradebook_action_bar_renderer_weightevaluation($context);
