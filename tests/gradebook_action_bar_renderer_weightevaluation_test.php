...
/**
 * Class gradebook_action_bar_renderer_weightevaluation_test
 *
 * Test cases for the action bar renderer used in the Grade Config Wizard for weight evaluation.
 */
class gradebook_action_bar_renderer_weightevaluation_test extends \advanced_testcase {
     ...
     * Test get_template.
     *
     * @covers \gradereport_gradeconfigwizard\gradebook_action_bar_renderer_weightevaluation::get_template
     */
    public function test_get_template() {
        $context = \context_course::instance($this->course1->id);
        $actionbarformula = new \gradereport_gradeconfigwizard\gradebook_action_bar_renderer_weightevaluation($context);
     ...
     *
     * @covers \gradereport_gradeconfigwizard\gradebook_action_bar_renderer_weightevaluation::export_for_template
     */
